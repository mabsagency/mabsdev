...
const translations = {
  fr: {
    ...
    legal_editor_text: 'Mabs Dev, portfolio de Mabou Yanis. Adresse : Douala, Logpom, Cameroun. Téléphone : +237 682 371 339. Contact : mabsdevfullstack@gmail.com',
    legal_host_title: 'Hébergement',
    legal_host_text: 'Hébergement : Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, États-Unis. Le site est déployé et distribué via la plateforme Vercel.',
  ...
  en: {
    ...
    legal_editor_text: 'Mabs Dev, portfolio of Mabou Yanis. Address: Douala, Logpom, Cameroon. Phone: +237 682 371 339. Contact: mabsdevfullstack@gmail.com',
    legal_host_title: 'Hosting',
    legal_host_text: 'Hosting: Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, United States. The website is deployed and delivered through the Vercel platform.',
...
function setupDOMListeners() {
  ...
  const projectDetails = [
    ...
    { slug: 'mused', title: 'Mused', description: t('project_desc_mused'), detail: currentLang === 'fr' ? 'Recherche et expérience UI · Accélérer la création de moodboards.' : 'Research and UI experience · Speeding up moodboard creation.', tech: 'Next.js · HTML · CSS · JavaScript · SQL', label: t('project_label_mused'), image: '/image/mused.jpg', alt: 'Moodboard minimaliste créé avec Mused', url: 'https://mused-tau.vercel.app' },
